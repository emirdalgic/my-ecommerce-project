        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4">
              Premium products, unbeatable prices. We are dedicated to providing the best shopping experience with a wide range of high-quality items.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/products" className="hover:text-blue-400 transition-colors">All Products</Link>
              </li>
              <li>
                <Link to="/cart" className="hover:text-blue-400 transition-colors">My Cart</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  to={userId ? `/profiles/${userId}` : "/login"}
              ...
              <li>
                <Link
                  to={userId ? "/orders/history" : "/login"}
                  className="hover:text-blue-400 transition-colors"
                >
                  Order History
                </Link>
              ...
              <li>
                <Link
                  to={userId ? "/profile/my-addresses" : "/login"}
                  className="hover:text-blue-400 transition-colors"
                >
                  Addresses
                </Link>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center">
                <span className="mr-2">📧</span>
                <a href="mailto:support@eshop.com" className="hover:text-blue-400 transition-colors">support@eshop.com</a>
              </li>
            </ul>
          </div>
